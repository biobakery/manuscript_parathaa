...
'Usage:
    GTDB_bench.R [-p <parathaa_PATH> --dada_db <dada2_db> --dada_db_sp <dada2_db_sp> -t <input_taxonomy> -o <output> --paraAssignV1V2 <taxonomy_file> --paraAssignV4V5 <taxonomy_file> --paraAssignFL <taxonomy_file> --queryV1V2 <query seqs> --queryV4V5 <query seqs> --queryFL <query seqs> -s <seed_data>]
