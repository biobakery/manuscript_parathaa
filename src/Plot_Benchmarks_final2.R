...
opts$specific <- "~/Dropbox_Harvard/hutlab/Jacob/Repos/Hills_Project/Parathaa_Project/Revisions2/output_specific_Aug_7_2025/benchmarks/"
opts$sensitive <- "~/Dropbox_Harvard/hutlab/Jacob/Repos/Hills_Project/Parathaa_Project/Revisions2/output_sens_Aug_7_2025/benchmarks/"
opts$output <- "~/Desktop/TMP2/"
library(dplyr)
library(ggplot2)
library(reshape2)
...
plot_benchs_species <- function(mult_bench, no_mult_bench, sens_bench){
  ...
  full_df_melt$Metric <- factor(full_df_melt$Metric, levels=c("F1 Score", "Accuracy", "Precision", 
                                                              ...
                                                              "One-to-many Correct", "Incorrect", "Unassigned Correct", 
...
FL_id_taxa1 <- FL_id_taxa %>% filter(!Metric %in% c("Unassigned Correct", "Unassigned Incorrect", "Accuracy", "Incorrect"))
...
colnames(FL_id_taxa)
FL_id_taxa$Dataset <- "Holdout"
FL_id_taxa2 <- FL_id_taxa %>% filter(!Metric %in% c("Unassigned Correct", "Unassigned Incorrect", "Accuracy", "Incorrect"))
...
colnames(FL_id_taxa)
FL_id_taxa$Dataset <- "Holdout"
FL_id_taxa3 <- FL_id_taxa %>% filter(!Metric %in% c("Unassigned Correct", "Unassigned Incorrect", "Accuracy", "Incorrect"))
...
V1V2_id_taxa1 <- V1V2_id_taxa %>% filter(!Metric %in% c("Unassigned Correct", "Unassigned Incorrect", "Accuracy", "Incorrect"))
...
colnames(V1V2_id_taxa)
V1V2_id_taxa$Dataset <- "Holdout"
V1V2_id_taxa2 <- V1V2_id_taxa %>% filter(!Metric %in% c("Unassigned Correct", "Unassigned Incorrect", "Accuracy", "Incorrect"))
...
colnames(V1V2_id_taxa)
V1V2_id_taxa$Dataset <- "Holdout"
V1V2_id_taxa3 <- V1V2_id_taxa %>% filter(!Metric %in% c("Unassigned Correct", "Unassigned Incorrect", "Accuracy", "Incorrect"))
...
V4V5_id_taxa1 <- V4V5_id_taxa %>% filter(!Metric %in% c("Unassigned Correct", "Unassigned Incorrect", "Accuracy", "Incorrect"))
...
colnames(V4V5_id_taxa)
V4V5_id_taxa$Dataset <- "Holdout"
V4V5_id_taxa2 <- V4V5_id_taxa %>% filter(!Metric %in% c("Unassigned Correct", "Unassigned Incorrect", "Accuracy", "Incorrect"))
...
colnames(V4V5_id_taxa)
V4V5_id_taxa$Dataset <- "Holdout"
V4V5_id_taxa3 <- V4V5_id_taxa %>% filter(!Metric %in% c("Unassigned Correct", "Unassigned Incorrect", "Accuracy", "Incorrect"))
...
ggsave("~/Dropbox_Harvard/hutlab/Jacob/Paper_Submissions/Parathaa/NAR/Figures/Figure2/Figure2_revised2_panelA.pdf",
       width=12, height=6)
...
ggsave("~/Dropbox_Harvard/hutlab/Jacob/Paper_Submissions/Parathaa/NAR/Figures/Figure2/supplemental_bench2.pdf",
       width=14, height=8)
